    ...
    <div className="navbar py-6">
      <div className="container mx-auto px-4 w-full max-w-7xl">
        <div className="navbar-box flex items-center justify-between">
            ...
            <ul className={`menu flex items-center gap-12 md:static absolute ${active ? "top-24 opacity-100" : "top-20 opacity-0"} left-1/2 -translate-x-1/2 md:-translate-x-0 md:flex-row flex-col md:bg-transparent bg-slate-700 w-full md:w-auto md:py-0 py-10 text-white md:text-black transition-all md:opacity-100 md:transition-none md:text-base md:text-xl`}>
                <li>
